...
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-001", datetime(2025, 3, 6, 12, 30, 00), "102", "T-102-01", "M006", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-002", datetime(2025, 3, 6, 15, 30, 00), "102", "T-102-01", "M007", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-02-003", datetime(2025, 3, 6, 15, 30, 00), "102", "T-102-02", "M008", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-02-004", datetime(2025, 3, 6, 18, 30, 00), "102", "T-102-02", "M009", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-005", datetime(2025, 3, 7, 18, 30, 00), "102", "T-102-01", "M010", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-02-006", datetime(2025, 3, 7, 21, 30, 00), "102", "T-102-02", "M001", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-007", datetime(2025, 3, 8, 21, 30, 00), "102", "T-102-01", "M002", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-001", datetime(2025, 3, 9, 12, 30, 00), "103", "T-103-01", "M003", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-002", datetime(2025, 3, 9, 15, 30, 00), "103", "T-103-01", "M004", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-02-003", datetime(2025, 3, 9, 15, 30, 00), "103", "T-103-02", "M005", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-02-004", datetime(2025, 3, 9, 18, 30, 00), "103", "T-103-02", "M006", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-005", datetime(2025, 3, 10, 18, 30, 00), "103", "T-103-01", "M007", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-02-006", datetime(2025, 3, 10, 21, 30, 00), "103", "T-103-02", "M008", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-007", datetime(2025, 3, 11, 21, 30, 00), "103", "T-103-01", "M009", True, False))
