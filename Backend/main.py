                    ...
                    "history": [
                        BookingResponse(
                            showtime=ShowtimeResponse(
                                showtime_id=b.showtime.showtime_id,  # Assuming the showtime is a valid object
                            ...
                            payment_method=PaymentResponse(payment_type=b.payment_method.payment_type),  # Assuming Payment has payment_type
                            total=b.total
...
memory_db.cinema_list[1].cinema_management.add_cinema_theater(Theater("T-102-01", "01", "IMAX", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[1].cinema_management.add_cinema_theater(Theater("T-102-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[2].cinema_management.add_cinema_theater(Theater("T-103-01", "01", "4DX", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[2].cinema_management.add_cinema_theater(Theater("T-103-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[3].cinema_management.add_cinema_theater(Theater("T-104-01", "01", "IMAX", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[3].cinema_management.add_cinema_theater(Theater("T-104-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[4].cinema_management.add_cinema_theater(Theater("T-105-01", "01", "Standard", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[4].cinema_management.add_cinema_theater(Theater("T-105-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[5].cinema_management.add_cinema_theater(Theater("T-106-01", "01", "IMAX", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[5].cinema_management.add_cinema_theater(Theater("T-106-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[6].cinema_management.add_cinema_theater(Theater("T-107-01", "01", "4DX", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[6].cinema_management.add_cinema_theater(Theater("T-107-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[7].cinema_management.add_cinema_theater(Theater("T-108-01", "01", "IMAX", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[7].cinema_management.add_cinema_theater(Theater("T-108-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[8].cinema_management.add_cinema_theater(Theater("T-109-01", "01", "Standard", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[8].cinema_management.add_cinema_theater(Theater("T-109-02", "02", "Standard", 32, True, "Dolby", "Standard"))
memory_db.cinema_list[9].cinema_management.add_cinema_theater(Theater("T-110-01", "01", "4DX", 32, True, "Dolby", "VIP"))
memory_db.cinema_list[9].cinema_management.add_cinema_theater(Theater("T-110-02", "02", "Standard", 32, True, "Dolby", "Standard"))

#create_showtime
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-01-001", datetime(2025, 3, 12, 12, 30, 00), "101", "T-101-01", "M001", True, False))
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-01-011", datetime(2025, 3, 12, 15, 30, 00), "101", "T-101-01", "M001", True, False))
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-02-002", datetime(2025, 3, 12, 15, 30, 00), "101", "T-101-02", "M010", True, False))
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-02-012", datetime(2025, 3, 12, 18, 30, 00), "101", "T-101-02", "M010", True, False))
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-01-003", datetime(2025, 3, 13, 18, 30, 00), "101", "T-101-01", "M002", True, False))
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-02-004", datetime(2025, 3, 13, 21, 30, 00), "101", "T-101-02", "M003", True, False))
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-01-005", datetime(2025, 3, 14, 21, 30, 00), "101", "T-101-01", "M004", True, False))
memory_db.cinema_list[0].cinema_management.add_cinema_showtime(Showtime("S-101-02-006", datetime(2025, 3, 14, 12, 30, 00), "101", "T-101-02", "M005", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-001", datetime(2025, 3, 12, 12, 30, 00), "102", "T-102-01", "M006", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-002", datetime(2025, 3, 12, 15, 30, 00), "102", "T-102-01", "M007", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-02-003", datetime(2025, 3, 12, 15, 30, 00), "102", "T-102-02", "M008", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-02-004", datetime(2025, 3, 12, 18, 30, 00), "102", "T-102-02", "M009", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-005", datetime(2025, 3, 13, 18, 30, 00), "102", "T-102-01", "M010", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-02-006", datetime(2025, 3, 13, 21, 30, 00), "102", "T-102-02", "M001", True, False))
memory_db.cinema_list[1].cinema_management.add_cinema_showtime(Showtime("S-102-01-007", datetime(2025, 3, 14, 21, 30, 00), "102", "T-102-01", "M002", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-001", datetime(2025, 3, 12, 12, 30, 00), "103", "T-103-01", "M003", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-002", datetime(2025, 3, 12, 15, 30, 00), "103", "T-103-01", "M004", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-02-003", datetime(2025, 3, 12, 15, 30, 00), "103", "T-103-02", "M005", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-02-004", datetime(2025, 3, 12, 18, 30, 00), "103", "T-103-02", "M006", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-005", datetime(2025, 3, 13, 18, 30, 00), "103", "T-103-01", "M007", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-02-006", datetime(2025, 3, 13, 21, 30, 00), "103", "T-103-02", "M008", True, False))
memory_db.cinema_list[2].cinema_management.add_cinema_showtime(Showtime("S-103-01-007", datetime(2025, 3, 14, 21, 30, 00), "103", "T-103-01", "M009", True, False))
...
def base_payment(payment: payment):
    ...
    reserved_seat_ids = account.reserved_list or []
...
def done_payment(payment: PaymentRequest):
    user_id = payment.user_id
    movie_id = payment.movie_id
    showtime_id = payment.showtime_id
    payment_type = payment.payment_type
